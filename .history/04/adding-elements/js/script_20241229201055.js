$(function () {
  ...
  $(".green-box").after(function() {
    return  $("<div class='green-box'>New Green Box</div>").appendTo($(".green-box").next());
  });
  
  $(".red-box").after(function() {
    return  $("<div class='red-box'>New Red Box</div>").appendTo($(".green-box").next());
  });

  $(".blue-box").after(function() {
    return  $("<div class='blue-box'>New Blue Box</div>").appendTo($(".blue-box").next());
  });
});