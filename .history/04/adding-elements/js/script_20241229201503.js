$(function () {
  ...
  //Move red-box before blue box
  // $(".blue-box:last").before($(".red-box"))

  $(".green-box").after(function() {
    return  $("<div class='blue-box'>New Blue Box</div>").appendTo($(".green-box").next());
  });
  
  $(".red-box").after(function() {
    return  $("<div class='green-box'>New Green Box</div>").appendTo($(".red-box").next());
  });

  $(".red-box").before(function() {
    return  $("<div class='red-box'>New Green Box</div>").appendTo($(".red-box").next());
  });
  // $(".blue-box").after(function() {
  //   return  $("<div class='red-box'>New Red Box</div>").appendTo($(".blue-box").next());
  // });
});